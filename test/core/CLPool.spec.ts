      ...
      describe('success cases', () => {
        ...
        describe('including current price', () => {
          ...
          it('writes an observation', async () => {
            ...
            await pool.advanceTime(15)
            await mint(wallet.address, minTick, maxTick, 100)
            checkObservationEquals(await pool.observations(0), {
              tickCumulative: -345420,
              blockTimestamp: TEST_POOL_START_TIME + 15,
              initialized: true,
              secondsPerLiquidityCumulativeX128: '1614753402029129057877449892906207899',
            })
          })
        })
