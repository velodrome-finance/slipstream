...
contract CalculateFeesFuzzTest is CLPoolTest {
    CLPool public pool;
    ...
    function testFuzz_FeesCalculatedCorrectlyDuringSwapsFullRangePositionsIntermediaryUnstakeAndStake(
        ...
        // swap 3 token0
        clCallee.swapExact0For1(address(pool), 3e18, users.alice, MIN_SQRT_RATIO + 1);
        ...
        // swap 2 token1
        clCallee.swapExact1For0(address(pool), 2e18, users.alice, MAX_SQRT_RATIO - 1);
    ...
    function testFuzz_FeesCalculatedCorrectlyDuringSwapsFullRangePositionsIntermediaryUnstakeAndStake(
        ...
        // swap token0
        clCallee.swapExact0For1(address(pool), swapAmount1, users.alice, MIN_SQRT_RATIO + 1);
        ...
        // swap token0
        clCallee.swapExact0For1(address(pool), swapAmount2, users.alice, MIN_SQRT_RATIO + 1);
        ...
        // swap token1
        clCallee.swapExact1For0(address(pool), swapAmount3, users.alice, MAX_SQRT_RATIO - 1);
        ...
        // swap token1
        clCallee.swapExact1For0(address(pool), swapAmount4, users.alice, MAX_SQRT_RATIO - 1);
    ...
    function testFuzz_FeesCalculatedCorrectlyDuringSwapsFullRangePositionsIntermediaryUnstakeAndStake(
        ...
        // swap token0
        clCallee.swapExact0For1(address(pool), fd.swapAmount1, users.alice, MIN_SQRT_RATIO + 1);
        ...
        // swap token0
        clCallee.swapExact0For1(address(pool), fd.swapAmount2, users.alice, MIN_SQRT_RATIO + 1);

        fg.feeGrowthGlobal0X128 += calculateFeeGrowthX128(fees.fee2, fd.liquidity1 + fd.liquidity2);
        assertFees(fees.fee1 - unstakedFeeDuringSwap, 0, fg.feeGrowthGlobal0X128, 0);

        // swap token1
        clCallee.swapExact1For0(address(pool), fd.swapAmount3, users.alice, MAX_SQRT_RATIO - 1);
        ...
        // swap token1
        clCallee.swapExact1For0(address(pool), fd.swapAmount4, users.alice, MAX_SQRT_RATIO - 1);
