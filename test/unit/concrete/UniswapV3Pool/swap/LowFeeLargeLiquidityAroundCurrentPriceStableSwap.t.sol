...
contract LowFeeLargeLiquidityAroundCurrentPriceStableSwapTest is UniswapV3PoolSwapTest {
    function setUp() public override {
        ...
        positions.push(Position({tickLower: -tickSpacing, tickUpper: tickSpacing, liquidity: liquidity}));
