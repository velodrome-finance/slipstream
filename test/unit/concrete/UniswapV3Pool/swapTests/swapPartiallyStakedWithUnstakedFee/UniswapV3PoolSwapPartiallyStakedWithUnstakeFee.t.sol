...
abstract contract UniswapV3PoolSwapPartiallyStakedWithUnstakeFeeTest is UniswapV3PoolSwapTests {
    ...
    function setUp() public virtual override {
        ...
        string memory path = string(
            abi.encodePacked(
                root,
                "/test/unit/concrete/UniswapV3Pool/swapTests/swapPartiallyStakedWithUnstakedFee/swap_assert_partially_staked_with_fee.json"
            )
        );
