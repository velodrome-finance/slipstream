...
contract MediumFee1to1Price0LiquidityAllLiquidityAroundCurrentPricePartiallyStakedWithUnstakedFeeTest is
    UniswapV3PoolSwapPartiallyStakedWithUnstakeFeeTest
{
    function setUp() public override {
        ...
        for (uint256 i = 0; i < positionsLength; i++) {
            ...
            // since we have the same number fo positions we mint the unsataked here as well
