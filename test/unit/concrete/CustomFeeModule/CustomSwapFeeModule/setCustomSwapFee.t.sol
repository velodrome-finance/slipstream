...
contract SetCustomSwapFeeTest is CustomSwapFeeModuleTest {
    ...
    function test_RevertIf_NotManager() public {
        ...
        vm.expectRevert();
        customSwapFeeModule.setCustomFee({_pool: address(1), _fee: 5_000});
    }
    ...
    function test_RevertIf_FeeTooHigh() public {
        ...
        vm.expectRevert();
        customSwapFeeModule.setCustomFee({_pool: pool, _fee: 30_001});
    }
    ...
    function test_SetCustomFee() public {
        ...
        customSwapFeeModule.setCustomFee({_pool: pool, _fee: 5_000});
        ...
        customSwapFeeModule.setCustomFee({_pool: pool, _fee: 0});
        ...
        customSwapFeeModule.setCustomFee({_pool: pool, _fee: 420});
