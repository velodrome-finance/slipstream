...
abstract contract CLPoolSwapTests is CLPoolTest {
    ...
    function test_swap_exactly_1_token0_for_token1() public {
        ...
        try clCallee.swapExact0For1(poolSetup.pool, amount0, users.alice, sqrtPriceLimitX96) {}
    ...
    function test_swap_exactly_1_token1_for_token0() public {
        ...
        try clCallee.swapExact1For0(poolSetup.pool, amount1, users.alice, sqrtPriceLimitX96) {}
        catch Error(string memory reason) {
            swapFailed = true;
            swapErrorMessage = reason;
        }
    ...
    function test_swap_token0_for_exactly_1_token1() public {
        ...
        try clCallee.swap0ForExact1(poolSetup.pool, amount1, users.alice, sqrtPriceLimitX96) {}
        catch Error(string memory reason) {
            swapFailed = true;
            swapErrorMessage = reason;
        }
    ...
    function test_swap_token1_for_exactly_1_token0() public {
        ...
        try clCallee.swap1ForExact0(poolSetup.pool, amount0, users.alice, sqrtPriceLimitX96) {}
        catch Error(string memory reason) {
            swapFailed = true;
            swapErrorMessage = reason;
        }
    ...
    function test_swap_token1_for_token0_to_price_2point5() public {
        ...
        try clCallee.swapToHigherSqrtPrice(poolSetup.pool, sqrtPriceLimitX96, users.alice) {}
        catch Error(string memory reason) {
            swapFailed = true;
            swapErrorMessage = reason;
        }
    ...
    function test_swap_token0_for_token1_to_price_0point4() public {
        ...
        try clCallee.swapToLowerSqrtPrice(poolSetup.pool, sqrtPriceLimitX96, users.alice) {}
        catch Error(string memory reason) {
            swapFailed = true;
            swapErrorMessage = reason;
        }
    ...
    function getAssertDataAfterSwap() internal view returns (SwapData memory sd) {
        (sd.sqrtPriceX96After, sd.tickAfter,,,,) = CLPool(poolSetup.pool).slot0();
        sd.liquidityAfter = CLPool(poolSetup.pool).liquidity();
        ...
        sd.feeGrowthGlobal0X128 = CLPool(poolSetup.pool).feeGrowthGlobal0X128();
        sd.feeGrowthGlobal1X128 = CLPool(poolSetup.pool).feeGrowthGlobal1X128();

        (sd.gaugeFeesToken0, sd.gaugeFeesToken1) = CLPool(poolSetup.pool).gaugeFees();
    }
}
